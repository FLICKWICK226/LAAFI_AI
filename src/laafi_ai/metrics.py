...
def find_threshold_for_target_sensitivity(
    y_true: np.ndarray, y_scores: np.ndarray, target_sensitivity: float = 0.98
) -> float:
    """
...
def compute_binary_metrics(
    ...
    thresh_98 = find_threshold_for_target_sensitivity(
        labels, probabilities, target_sensitivity=0.98
    )
...
def compute_bootstrap_metrics(
    ...
    bootstrap_metrics = {
        ...
        "specificity": [],
        "precision": [],
        "specificity_at_98_sens": [],
        "precision_at_98_sens": [],
    }
