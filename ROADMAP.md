...
- [ ] Implémenter la normalisation Macenko ou Vahadane pour corriger les variations de coloration H&E entre laboratoires
...
- [ ] Appliquer temperature scaling ou Platt scaling pour calibrer les probabilités
- [ ] Tracer un diagramme de fiabilité (reliability diagram)
- [ ] Optimiser le seuil de décision via la courbe ROC (Youden's J) plutôt que 0.5 par défaut
- [ ] Rapporter les intervalles de confiance (bootstrap) sur toutes les métriques

---

## 🔲 Phase 4 : Pipeline MLOps

- [ ] Intégrer MLflow ou DVC pour le suivi des expériences
- [ ] Versionner les checkpoints et les données avec DVC
- [ ] Automatiser l'entraînement avec des scripts reproductibles (pas seulement notebooks)
- [ ] Ajouter un pipeline CI/CD : tests, lint, formatage
